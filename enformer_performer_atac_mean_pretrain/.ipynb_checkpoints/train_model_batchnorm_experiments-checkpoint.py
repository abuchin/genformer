    ...
    def sweep_train(config_defaults=None):
        ...
        with strategy.scope():
            ...
            run_name = '_'.join([str(wandb.config.input_length)[:3] + 'k',
                                 ...
                                 'wd_1-' + str(wandb.config.wd_1),
                                 'wd_2-' + str(wandb.config.wd_2),
            ...
            dist_train_step,dist_val_step,dist_val_step_TSS,build_step, metric_dict = \
