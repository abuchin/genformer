...
class Enformer(snt.Module):
    ...
    def __init__(self,
        ...
        self.new_head_profile = Sequential(snt.Linear(num_channels), tf.nn.softplus)
        self.new_head_peaks = Sequential(snt.Linear(num_channels), tf.nn.sigmoid)
    ...
    def __call__(self, inputs: tf.Tensor,
        ...
        return self.new_head_profile(trunk_embedding), self.new_head_peaks(trunk_embedding)
