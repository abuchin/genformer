...
def main():
    ...
    sweep_config = {
            ...
            'parameters': {
                ...
                'epsilon': {
                    'values':[args.epsilon] # number_peaks
                },
                'number_peaks': {
                    'values':[int(x) for x in args.number_peaks.split(',')]
                },
                'load_init': {
                ...
                'dim_reduce_length_seq_crop': {
                    'values': [args.dim_reduce_length_seq_crop]
                },
                'dim_reduce_length_class': {
                    'values': [args.dim_reduce_length_class]
                },
                'dim_reduce_length_class_crop': {
                    'values': [args.dim_reduce_length_class_crop]
                },
                'loss_type': {
    ...
    def sweep_train(config_defaults=None):
        ...
        with strategy.scope():
            ...
            model = aformer.aformer(kernel_transformation=wandb.config.kernel_transformation,
                                    ...
                                    dim_reduce_length_seq_crop=wandb.config.dim_reduce_length_seq_crop,
                                    dim_reduce_length_class=wandb.config.dim_reduce_length_class,
                                    dim_reduce_length_class_crop=wandb.config.dim_reduce_length_class_crop,
