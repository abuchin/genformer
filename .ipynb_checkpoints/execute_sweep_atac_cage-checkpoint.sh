...
python3 train_model_atac_cage.py \
            ...
            --val_examples_TSS=61886 \
            --val_examples_TSS_ho=6402 \
            --BN_momentum=0.90 \
            --warmup_frac=0.004 \
            --patience=50 \
            --output_res=128 \
            ...
            --load_init="True" \
            --rectify="True" \
            --multitask_checkpoint_path="gs://picard-testing-176520/genformer_atac_pretrain/models/aformer_hg_262k_load-True_LR-0.01_T-7_D-0.3_2023-04-13_15:39:43/final" \
